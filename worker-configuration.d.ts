/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareBindings` (hash: 2dba3f69d921c69c1fd2a9d7a05ab8e0)
...
interface __BaseEnv_CloudflareBindings {
	...
	ADMIN_WEBSITE_URL: string;
	PUBLIC_WEBSITE_URL: string;
	CLOUDINARY_CLOUD_NAME: string;
	CLOUDINARY_API_KEY: string;
	CLOUDINARY_API_SECRET: string;
	WRANGLER_LOG: string;
	WRANGLER_LOG_PATH: string;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NODE_ENV" | "PORT" | "DATABASE_URL" | "BETTER_AUTH_URL" | "BETTER_AUTH_SECRET" | "ADMIN_WEBSITE_URL" | "PUBLIC_WEBSITE_URL" | "CLOUDINARY_CLOUD_NAME" | "CLOUDINARY_API_KEY" | "CLOUDINARY_API_SECRET" | "WRANGLER_LOG" | "WRANGLER_LOG_PATH">> {}
}
